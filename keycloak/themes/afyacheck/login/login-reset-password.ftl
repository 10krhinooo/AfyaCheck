<#-- Copied from base/login/login-reset-password.ftl (parent theme's parent — keycloak.v2 doesn't
...
<@layout.registrationLayout displayInfo=true displayMessage=!messagesPerField.existsError('username') brandTitle="We'll get you back in" brandBody="Enter your username or email and we'll send you instructions to reset your password."; section>
    <#if section = "header">
