# Adaptive question sequencing: decides which question to ask next from a
# partial answer set, using a trained decision-tree model plus smart
# business-logic fallback rules. Split out of decision_tree_service.py,
# which now only wires this up behind FastAPI routes.
import logging
